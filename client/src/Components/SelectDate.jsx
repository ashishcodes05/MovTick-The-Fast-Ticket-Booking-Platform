...
const SelectDate = ({ dateTime, id }) => {
    ...
    return (
        <div className="px-6 md:px-16 lg:px-36 py-5">
            <div className="bg-primary/10 px-8 py-12 rounded-xl flex flex-col gap-4">
                <h1 className="text-lg font-semibold mb-2">Please Select a Date</h1>
